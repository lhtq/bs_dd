	...
	<body>
		...
		<div class="fill_message">
			...
			<table class="tab_login">
				...
				<!-- 订单开始 -->
				<c:forEach var="c" items="${cart }" varStatus = "stu">
					<tr>
						<td valign="top">
							${stu.count }
						</td>
			...
			<div class="login_in">
				<a href="../cart/cart_list.jsp">
					<input id="btnClientRegister1" class="button_1" name="submit" type="submit" value="取消" />
				</a>		
				<a href="${pageContext.request.contextPath}/address/selectByUser_id"><!-- address_form.jsp -->
